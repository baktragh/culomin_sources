...
cc65 -O2 -t atari5200  -o build/clm1_alt.s main_alt.c
...
ld65 -C linker.cfg --mapfile map_alt.txt -o culomin5200_alt.bin build/clm_sup.o build/clm1_alt.o build/data.o atari5200.lib
